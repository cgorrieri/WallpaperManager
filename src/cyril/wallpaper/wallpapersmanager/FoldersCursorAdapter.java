...
public class FoldersCursorAdapter extends CursorAdapter {
		...
		view.setOnLongClickListener(new OnLongClickListener() {
			public boolean onLongClick(final View v) {
				...
				AlertDialog.Builder builder = new AlertDialog.Builder(
						WallpapersTabActivityGroup.group);
				...
				builder.setItems(items, new DialogInterface.OnClickListener() {
					public void onClick(DialogInterface dialog, int item) {
						...
						case 1:
							...
							rtlDBA1.open();
							RotateList rtl = new RotateList(fd.getName());
						...
						case 2:
							...
							break;
						case 3:
							AlertDialog.Builder rename_folder_dl = new AlertDialog.Builder(
									WallpapersTabActivityGroup.group);
							rename_folder_dl.setTitle("Rename Folder");

							final EditText folder_name_box = new EditText(mContext);
							folder_name_box.setText(fd.getName());
							folder_name_box.setMaxLines(1);
							folder_name_box
									.setInputType(InputType.TYPE_CLASS_TEXT);
							folder_name_box.setSelection(0, fd.getName().length());
									...
									new DialogInterface.OnClickListener() {
										public void onClick(DialogInterface d,
											...
											FoldersDBAdapter fdsDBA = new FoldersDBAdapter(
													mContext);
											fdsDBA.open();
											fdsDBA.updateFolder(new Folder(fd
							...
							break;
						case 4:
							WallpapersDBAdapter wppDBA2 = new WallpapersDBAdapter(
									mContext);
							wppDBA2.open();
							ArrayList<Wallpaper> wpp_al = wppDBA2
									.getWallpapersFromFolder(fd);
	...
	private void openFolder(Folder fd) {
		Intent wallpapers = new Intent(mContext, WallpapersActivity.class);
		wallpapers.putExtra("folder_id", fd.getId());
